...
from locations.infrastructure.supabase_location_repository import SupabaseLocationRepository
...
def get_get_all_locations_usecase(repo: LocationRepository = Depends(get_location_repository)) -> GetAllLocationsUseCase:
